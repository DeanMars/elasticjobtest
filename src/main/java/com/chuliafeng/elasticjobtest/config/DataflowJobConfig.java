...
package com.chuliafeng.elasticjobtest.config;

import com.chuliafeng.elasticjobtest.job.dataflow.SpringDataflowJob;
import com.chuliafeng.elasticjobtest.job.listenter.JobListener;
...
public class DataflowJobConfig {
    ...
    public JobScheduler dataflowJobScheduler(final DataflowJob dataflowJob, @Value("${dataflowJob.cron}") final String cron,
        ...
        return new SpringJobScheduler(dataflowJob, regCenter, getLiteJobConfiguration(dataflowJob.getClass(), cron,
                shardingTotalCount, shardingItemParameters), jobEventConfiguration,new JobListener());
    }
